...
export default function LecturePlanPage() {
    ...
    const downloadSample = () => {
        ...
        const csvContent = `id,subject,period_no,proposed_date,topic,actual_completion_date,remarks\n,${defaultSubject},1,2024-01-20,Introduction to Calculus,2024-01-20,Completed`
